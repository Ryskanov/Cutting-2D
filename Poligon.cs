...
{   //****************************************************************
	...
	public class Poligon
	{
		...
		public void Move(float xMove, float yMove)
		{
			...
			{
				var point = arrVertex[i];
				arrVertex[i] = new PointF(point.X + xMove, point.Y + yMove);
			}
		}
		...
		public void Draw(Graphics g, Pen pen)
		{
			...
			{
				var count = arrVertex.Length;
				for (int i = 0; i < count; i++)
				{
					var startIndex = i;
					var stopIndex = (i + 1) % count;
					g.DrawLine(pen, arrVertex[startIndex], arrVertex[stopIndex]);
				}
			}
		}
